...
<h1>Muxel Theme <span style="font-size: small">v2.0.0</span></h1>
...
It's built for performance and simplicity, and it offers a light-first design (with dark mode support coming in version 2.0.0), and responsive layouts.
...
cd ../..
```
See more of the configurations from [_**the blog**_](https://blog.logstack.dev/muxel-theme-configuration/).
```bash
